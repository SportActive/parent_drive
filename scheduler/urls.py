...
urlpatterns = [
    ...
    # API-ендпоінти для контекстного меню
    path('api/get-parents/', views.get_parents_list, name='get_parents_list'),
    path('api/admin-assign-driver/', views.admin_assign_driver, name='admin_assign_driver'),
]